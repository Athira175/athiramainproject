...
if(isset($_POST['submit'])){
	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			...
			$image=rand(111111111,999999999).'_'.$_FILES['image']['name'];
			move_uploaded_file($_FILES['image']['tmp_name'],'../media/product/'.$image);
			mysqli_query($con,"insert into product(categories_id,name,price,meta_title,meta_desc,meta_keyword,status,image) values('$categories_id','$name','$price','$meta_title','$meta_desc','$meta_keyword',1,'$image')");
		}
                        ...
                        <form method="post" enctype="multipart/form-data">
							<div class="card-body card-block">
							   <div class="form-group">
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">Catering Name</label>
									<label style="color:red;">*</label>
								...
								<!--<div class="form-group">
									<label for="categories" class=" form-control-label">package Type</label>
									<label style="color:red;">*</label>
								...
								<div class="form-group">
									<label for="categories" class=" form-control-label">Auditorium Type</label>
									<label style="color:red;">*</label>
									<textarea name="description" placeholder="Enter product description" class="form-control" required><?php echo $description?></textarea>
								</div>-->
								
								<div class="form-group">
									<label for="categories" class=" form-control-label">Food Type</label>
									<label style="color:red;">*</label>
									<textarea name="meta_title" placeholder="Enter food type" class="form-control"><?php echo $meta_title?></textarea>
								</div>
								
								<div class="form-group">
									<label for="categories" class=" form-control-label">Short Description</label>
									<label style="color:red;">*</label>
									<textarea name="meta_desc" placeholder="Enter product short description" class="form-control"><?php echo $meta_description?></textarea>
								</div>

  ...
  <main id="main">
   <section class="breadcrumbs">
    ...
    <p style="margin-left:23%;">Email</p>
                <input type="text" name="email"  placeholder="enter Email" class="email_new" style='padding:10px 30px'><br>
                <p style="margin-left:23%;"> Password</p>
<input type="password" name="password" placeholder="Enter Password" class="pass_new" style='padding:10px 30px'><br>
<input type="Submit" name="login-btn" value="Login" class="button_new bg-success text-light"><br><br>
      </div>
          </div>
          </div>
          </div>
